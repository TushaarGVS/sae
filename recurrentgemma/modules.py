...
class RecurrentBlockCache(NamedTuple):
    ...
    all_rg_lru_states: at.AllRNNStates | None = None
    mlp_activations: at.ExpandedActivations | None = None
...
class LocalAttentionBlock(nn.Module):
    ...
    def forward(
        ...
        return_xai_intermediates: bool = False,
...
class RecurrentBlock(nn.Module):
    ...
    def forward(
        ...
        Args:
          ...
          return_cache: Whether to compute and return the updated cache.
          return_xai_intermediates: Whether to return all hidden states from RG-LRU.
        ...
        # all_recurrent_states: (b, l, e)
        all_rg_lru_states, rg_lru_state = self.rg_lru(
            x=x,
            segment_pos=segment_pos,
        ...
        return x, RecurrentBlockCache(
            ...
            all_rg_lru_states=(
                all_rg_lru_states.detach().cpu() if return_xai_intermediates else None
            ),
        )
...
class ResidualBlock(nn.Module):
    ...
    def forward(
        ...
        Args:
          ...
          return_cache: Whether to compute and return the updated cache.
          return_xai_intermediates: Whether to return explainability intermediates.
        ...
        x, cache = self.temporal_block(
            ...
            cache,
            return_cache=return_cache,
            return_xai_intermediates=return_xai_intermediates,
        )
        ...
        if return_xai_intermediates:
            cache = cache._replace(mlp_activations=mlp_out.detach().cpu())
